...
import { createProduct, ProductState } from '@/app/lib/actions'; // Ajusta la importación según tu archivo de acciones
...
export default function FormProduct({
  ...
  const [state, formAction] = useActionState(createProduct, initialState); // Cambia el nombre de la acción a createProduct
