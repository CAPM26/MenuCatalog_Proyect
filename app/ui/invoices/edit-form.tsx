...
export default function EditInvoiceForm({
  ...
  // y nos aseguramos de capturar la variable 'state' para el manejo de errores.
    ...
    <form action={formAction}>
      <div className="rounded-md bg-gray-50 p-4 md:p-6">
        ...
        <div className="mb-4">
          ...
          {/* Manejo de errores para Customer ID */}
